...
Golden rule of writing: __Who is your audience?__
...
"Keep your eye on the biology!" \vspace{1em}
...
## Models as "ammuntion" for arguments
...
- We use scientific literature to support our claims
- Models act as a _form of evidence_, translating raw data into support for your claim
...
- Slopes and intercepts have physical interpretations
  ...
  - Slope: + 1 % forest = + 1 bat\footnotemark
...
\footnotetext{For GLMs, slopes are viewed in log or log-odds (logit) units}
...
- Allows the reader to skip to the section they want, and quickly assess whether this paper is something they should keep reading
...
- What new things have we learned? How might this affect theory or practice? Should non-bat people pay attention to this paper?
  - "If we want to preserve bats, conservation practices should target forest cover"
