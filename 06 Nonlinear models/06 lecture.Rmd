...
- Try doing this for a Michaelis-Menten model
...
- Hard way: math (calculate the Hessian of the objective function with respect to parameters) 

## "There's got to be a better way!"

- Good news: someone already did the math for you!

- e.g. `SSasymp`, `SSlogis`, `SSmicmen`
...
- Sometimes we don't know the specific rules that govern your system
  - e.g. population changes across time, but we don't really know how
