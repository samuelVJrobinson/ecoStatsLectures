...
The logistic growth model $n_t = n_{t-1}(1+ r(1-\frac{n_{t-1}}{k}))$ is commonly used in ecology. It's definite solution over time is:
...
- Medium way: MCMC sampling (Bayesian estimation)
...
- Try fitting Michaelis-Menten model using:
