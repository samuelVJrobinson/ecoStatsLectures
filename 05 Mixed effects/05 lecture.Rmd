...
```{r canolaModPlot,width=5,height=5,warning=FALSE,message=FALSE}
plot(ggpredict(canMod,terms=c('VegMass')))+
  labs(x='Plant size',y='Pod success',title='Big plants have proportionally more pods')
```
...
```{r canModRes, warning=FALSE, message=FALSE}
...
\centering Above all: avoid selecting models based on $R^2$ or AIC alone
