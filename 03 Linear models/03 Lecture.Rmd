...
simModEff2 <- ggeffect(simMod,terms=c('X5')) 
...
- Create a causal diagram of your own data

1. List all of the things you measured as _boxes_
2. Draw relationships between ovals using _arrows_
3. If a relationship is unclear, use a _double-headed arrow_