...
Modeling philosophy: all models are approximating a __generative process__.

_It is up to us to think about what this process might be like._
...
Rules for plotting model results:  
...
- Since we're all biologists, here's some bat data!
  - `batDat.csv`
- Data: 100 bat weights from 2 cities, recorded along with sex and age
- How do these variables affect bat weight? 
  - Think about how these variables might be related to weight using __your brain__
...
```{r, echo=TRUE, out.width='100%', fig.asp=0.45} 
