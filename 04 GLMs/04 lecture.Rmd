...
- Dr. _Paulo Malpern_ (Paul Galpern's evil nemesis) sent 2 people out to check out some bee habitats in Edmonton and Calgary. Counted bees at each site, but the other one was really lazy, and just recorded "bees or no bees" (1 or 0).
...
- How do the models look? Compare the coefficients and see if they are different
  - Bonus: make partial regression plots of the terms each GLM
