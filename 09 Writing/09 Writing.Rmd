...
- Go back through each section and write general "overall" comments
  ...
  - Make sure to provide a suggested way forward, where possible! (e.g. "I suggest moving this paragraph to here...")
...
There are many other ways to do peer review, such as [this](https://doi.org/10.1007/s00264-020-04504-1)
